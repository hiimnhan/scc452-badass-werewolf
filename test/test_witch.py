...
player_witch = Witch(name=witch_player_name, model=lm_model, game_id="g042")
...
if __name__ == "__main__":
    ...
    def test_game_flow():
        ...
        _ = player_witch.update_suspicion_from_statement(
            speaker_name="Bob",
            statement="I am a Seer. I looked into Selena and Raj and see that they are both wolves. We need to vote them out.",
        )
